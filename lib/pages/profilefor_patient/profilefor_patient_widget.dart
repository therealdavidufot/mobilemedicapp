...
import 'profilefor_patient_model.dart';
export 'profilefor_patient_model.dart';

class ProfileforPatientWidget extends StatefulWidget {
  const ProfileforPatientWidget({super.key});

  @override
  State<ProfileforPatientWidget> createState() =>
      _ProfileforPatientWidgetState();
}

class _ProfileforPatientWidgetState extends State<ProfileforPatientWidget> {
  late ProfileforPatientModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileforPatientModel());
  }
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(25.0, 25.0, 35.0, 0.0),
                child: Row(
                  mainAxisSize: MainAxisSize.max,
